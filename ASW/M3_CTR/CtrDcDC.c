...
void CtrV2XDcDcOutCurrCtr(void)
{
	...
	default:
		...
		//DA5 = gPi2P2ZIDcDcOut[CurrSnsrPhase1].Ref;
		//DA6 = gPi2P2ZIDcDcOut[CurrSnsrPhase1].Fdb;
		//DA7 = gPi2P2ZIDcDcOut[CurrSnsrPhase1].FF;
		//DA8 = gPi2P2ZIDcDcOut[CurrSnsrPhase1].out;
